...
if __name__ == "__main__":
    ...
    parser.add_option("-v", "--verbose", action="store", type="int", dest="v", default=True,
                      help="prints more, default=%default", metavar="BOOL")
    ...
    validopts = ['setfreq','errors','init','on','off','getfreq']
