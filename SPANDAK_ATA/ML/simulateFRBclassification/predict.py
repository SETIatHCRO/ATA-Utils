...
def extract_candidates(fil_file, frb_cands, frbcand_path, NCHAN, NTIME, manualzap,save_png=False):
    ...
    PlotCand_dom.extractPlotCand(fil_file, frb_cands, noplot, fl, fh, tint, Ttot, kill_time_range,
                                    ...
                                    zerodm, csv_file, save_png, frbcand_path, manualzap)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-Z', dest='zap_chan_manual', type=str, default=None, help="Zaps the input filterbank file (only works with Heimdall and plotting). " \
    ...
    NTIME = args.NTIME
    print("manualzap")
    print(args.zap_chan_manual)
    manualzap = str(args.zap_chan_manual)
    #manualzap = str("10:1085,1100:6640")
    print(manualzap)
    ...
    if args.skip_extract is False:
        ...
        extract_candidates(filterbank_candidate, frb_cand_info, frb_cand_path, NCHAN, NTIME,manualzap)
