...
$cmd -i 0 1 2 3 -s rfsoc1-ctrl-1 $fpgfile $cfg --eth_spec -p 4031,4032,4033,4034 --skipprog

$cmd -i 0 1 2 3 -s rfsoc2-ctrl-1 $fpgfile $cfg --eth_spec -p 4041,4042,4043,4044 --skipprog

$cmd -i 0 1 2 3 -s rfsoc3-ctrl-1 $fpgfile $cfg --eth_spec -p 4051,4052,4053,4054 --skipprog

$cmd -i 0 1 2 3 -s rfsoc4-ctrl-1 $fpgfile $cfg --eth_spec -p 4061,4062,4063,4064 --skipprog

$cmd -i 0 1 2 3 -s rfsoc5-ctrl-1 $fpgfile $cfg --eth_spec -p 4071,4072,4073,4074 --skipprog
