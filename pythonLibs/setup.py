...
setuptools.setup(
    ...
    license='MIT',
    packages=['ATAdb', 'ATATools','ATAobs','HpguppiMon','SNAPobs','SNAPobs.snap_dada', 'SNAPobs.snap_hpguppi', 'OnOffCalc','OnOffCalc.flux','OnOffCalc.yFactor','OnOffCalc.misc','OnOffCalc.filterArray'],
